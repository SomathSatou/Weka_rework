...
public class Controller {
    ...
    public Resultat_tableau arbreJ48( String chemin_file ) {
        ...
        try {
             ...
             * information For example, the XRFF format saves the class
             * attribute information as well ca c'est important
             */
            if ( data.classIndex() == -1 )
                data.setClassIndex( data.numAttributes() - 1 );

            String[] options = new String[2]; // changer la taille si plus
                                              // d'argments en compte
            J48 tree = new J48(); // new instance of tree

            /* boucle en fonction du nombre d'exemple */
            for ( int i = 2; i < nbr_instances; i += nbr_instances * 0.1 ) {
                System.out.println(
                        " itération : " + nbr_iterations_pour_le_test + ", nombre de feuilles minimum : " + i );
                ...
                eval.crossValidateModel( tree, data, 5, new Random( 1 ) ); // ici
                                                                           // 5
                                                                           // constante
                                                                           // pour
                                                                           // la
    ...
    public Resultat_tableau randomForest( String chemin_file ) {
        Resultat_tableau resultat = new Resultat_tableau();
